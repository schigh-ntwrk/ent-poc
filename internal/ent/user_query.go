...
type UserQuery struct {
	...
	// eager-loading edges.
	withVeterinarian *VeterinarianQuery
...
// QueryVeterinarian chains the current query on the veterinarian edge.
func (uq *UserQuery) QueryVeterinarian() *VeterinarianQuery {
	query := &VeterinarianQuery{config: uq.config}
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withVeterinarian: uq.withVeterinarian.Clone(),
...
//  WithVeterinarian tells the query-builder to eager-loads the nodes that are connected to
// the "veterinarian" edge. The optional arguments used to configure the query builder of the edge.
func (uq *UserQuery) WithVeterinarian(opts ...func(*VeterinarianQuery)) *UserQuery {
	query := &VeterinarianQuery{config: uq.config}
	for _, opt := range opts {
		opt(query)
	}
	uq.withVeterinarian = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withVeterinarian; query != nil {
		...
		query.Where(predicate.Veterinarian(func(s *sql.Selector) {
			s.Where(sql.InValues(user.VeterinarianColumn, fks...))
		}))
